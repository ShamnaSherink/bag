...
export default function Registration() {
   const registration = useSelector(state => state.register.registration);
        ...
        <Toaster/>
         <div className='registercontainer'>
            <div className="container1">
               ...
               <div className="form-group">
                  <label style={{ color: errorMessage?.phone_number ? 'red' : '' }} htmlFor="phone_number">Phone Number:</label>
                  <input
